...
export const mockPersonalInfo: IUserPersonalInfo = {
  ...
  companyName: "Test",
  email: "Test@test.com",
  officialId: "56465df654",
  phoneNumber: "+ 971-2823591",
  refrences: ["ewf", "Fujahereirah", "regregthj"],
};
...
const PersonalInfoTab = ({
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="bg-[#F0F2F6] py-5 px-10 rounded-lg flex gap-10 items-center justify-around">
        <div className="flex flex-col gap-3">
          <InfoField label="Full Name" value={personalInfo.fullName} />
          <InfoField label="Email Address" value={personalInfo.email} />
          <InfoField label="Official ID" value={personalInfo.officialId} />
        </div>
        <div className="flex flex-col gap-3">
          <InfoField label="Company Address" value={personalInfo.companyName} />
      ...
      <div className="bg-[#F0F2F6] py-5 px-10 rounded-lg flex gap-16 items-start">
        <RefrencesSection data={personalInfo.refrences} />
      </div>
    </div>
  );
};
...
const RefrencesSection = ({ data }: { data: string[] }) => (
  <div className="flex flex-col gap-3">
    <h4 className="text-[#a0a0a0] mb-5">Refrences</h4>
    <div>
      {data.map((item, index) => (
